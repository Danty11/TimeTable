            ...
            <div v-for="note in reportStore.ReportsData" dir="rtl" style="color: black;" class="mt-4">
                <div class="d-flex justify-space-between elevation-6 pa-2 rounded-">
                    <div  @click="reportStore.editReportInfo = note , reportStore.reportId = note.id ,reportStore.editReportDialog = true, console.log(reportStore.editReportInfo.attachment)" class="d-flex">
                        <img v-if="note.attachment" :src="`http://mwo88k4ckooocck004o0cgk8.158.220.126.158.sslip.io//${note.attachment[0]}`" class="rounded-lg" style="max-width: 150px; max-height: 120px; min-height: 120px; background-color: aqua; object-fit: cover;"> 
        ...
        <div class="mt-4">
          <div class="d-flex" v-if="reportStore.editReportInfo.attachment.length > 0" >
            ...
            <div class="d-flex justify-center mx-4" style="width: 100%; height: 180px;">
              <img v-if="reportStore.editReportInfo.attachment.length > 0" :src="`http://mwo88k4ckooocck004o0cgk8.158.220.126.158.sslip.io//${reportStore.editReportInfo.attachment[index]}`" class="rounded-lg" style="max-width: 300px; max-height: 250px; min-height: 120px; background-color: aqua; object-fit: cover;"> 
